...
class ObjectInspector(propgrid.PropertyGrid):
    ...
    def OnChange(self, event):
        ...
        try:
            ...
            print('did we passed here')
        except Exception as err:
            # print('error come from OnChange')
            print(err)
    ...
    def GetProperty(self, attr, val):
        ...
        if prop is None:
            ...
            prop.Enable(False)
            return prop
        # print(prop(attr,value=val))
        # print(type(prop(attr, value=val)))
...
class SizeProperty(propgrid.PyProperty):
    ...
    def __init__(self, label, name='', value=0):
...
class MyFrame(wx.Frame):
    def __init__(self, parent, title=""):
        ...
        # Set the panel
        sizer = wx.BoxSizer()
        sizer.Add(MyPanel(self), 1, wx.EXPAND | wx.ALL , 10)
        self.SetSizer(sizer)

        self.SetInitialSize((500, 450))
